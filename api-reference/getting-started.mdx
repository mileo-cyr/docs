...
<Card title="New Partner API" icon="arrow-right" href="/new-partner-api/introduction">
  A successor to this API is available. It covers the same provisioning and reporting areas against
  the current Cyrisma platform, uses JSON, and is served entirely from your instance host. This
  Legacy Partner API remains available and unchanged.
</Card>